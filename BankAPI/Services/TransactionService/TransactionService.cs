...
namespace BankAPI.Services.TransactionService
{
    public class TransactionService : ITransactionService
    {
        ...
        private readonly YourBankDbContext _dbContext;
        private ILogger<TransactionService> _logger;
        private IAccountServices _userService;
       
        private static string _bankSettlementAccount;

        public TransactionService(YourBankDbContext dbContext, ILogger<TransactionService> logger, IAccountServices userService)
        {
